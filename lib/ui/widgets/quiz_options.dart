...
import 'package:generalknowledge/resources/api_provider.dart';
import 'package:generalknowledge/ui/pages/error.dart';
import 'package:generalknowledge/ui/pages/quiz_page.dart';
...
class _QuizOptionsDialogState extends State<QuizOptionsDialog> {
  ...
  Widget build(BuildContext context){
    return SingleChildScrollView(
        child: Padding(
          padding:  EdgeInsets.fromLTRB(8.0,8.0,8.0 ,AdSize.smartBanner.height.toDouble()),
          child: Column(
            children: <Widget>[
              Container(
              ...
              SizedBox(height: 20.0),
             // SizedBox(height: AdSize.smartBanner.height.toDouble()),
            ],
          ),
        ),
      );
